...
const DEDICATED_RAPTOR_WAVE_PREFIXES = [
    'MINI_BOSSES',
    'EXP_WAVE',
    'DOOM_MODE'
];
    ...
    sortedGroups.forEach(([displayName, fileGroups]) => {
        ...
        sortedFileGroups.forEach(fileGroup => {
            ...
            sortedSections.forEach(section => {
                const isDedicatedWaveSection = DEDICATED_RAPTOR_WAVE_PREFIXES.some(prefix =>
                    typeof section.name === 'string' && section.name.startsWith(prefix)
                );
