...
function generateLuaTweakRaw(type, multiplierValue) {
    ...
    if (type === 'qhp') { // Raptor Queen HP
        ...
        switch (multiplierNum) {
            case 1.3: metalCostFactor = '0.576923077'; break;
            case 1.5: metalCostFactor = '0.466666667'; break;
            case 1.7: metalCostFactor = '0.411764706'; break;
            case 2:   metalCostFactor = '0.35'; break;
            case 2.5: metalCostFactor = '0.3'; break;
            case 3:   metalCostFactor = '0.25'; break;
            case 4:   metalCostFactor = '0.1875'; break;
            case 5:   metalCostFactor = '0.15'; break;
            default:  metalCostFactor = '1'; break;
        }
